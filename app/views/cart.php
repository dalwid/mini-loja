        ...
        <div class="row d-flex justify-content-center align-items-center h-100">
            <div class="col-10">
                    ...
                    <div class="card-body p-4">
                        <div class="row d-flex justify-content-between align-items-center">
                            ...
                            <div class="col-md-3 col-lg-3 col-xl-3">
                                ...
                                <p><span class="text-muted"><?= $product->getQuantity() ?> X R$ <?php echo number_format($product->getPrice(),2, ',', '.')?></p>
                            </div>
                            ...
                            <div class="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                                <h5 class="mb-0"> R$ <?php echo number_format($product->getQuantity() * $product->getPrice(),2, ',', '.') ?></h5>
                ...
                <?php if($instances['cart']::getTotalProductsInCart() > 0): ?>
                    <div class="card">
                        <div class="card-body">
                            <a href="/checkout" type="button" class="btn btn-warning btn-block btn-lg">Proceed to Pay</a> 
                        </div>
                    </div>
                <?php endif; ?>
